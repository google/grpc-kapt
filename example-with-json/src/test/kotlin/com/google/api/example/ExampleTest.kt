...
private const val PORT = 8282

@ExperimentalCoroutinesApi
class ExampleTest {

    companion object {
        private var server = ComplexServer().asGrpcServer(PORT).also { it.start() }
...
private fun <T> withClient(block: suspend (ComplexServiceClient) -> T) = runBlocking {
